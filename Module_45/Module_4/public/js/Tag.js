...
duongdan = duongdan.replace("http://", "");
var ddExplore = duongdan.split("/");
var svName = ddExplore[0]+'/'+ddExplore[1];
svName = "http://"+svName;
//alert(svName);

var Tag = {	
		
	url : svName+"/admin/tagsadmin.php", /* url to script handling ajax for tags - modify path here */
	path: svName+"/tags/", /* url to tags-directory - modify path here */
